...
export default async function DocumentsPage() {
  ...
  return <DocumentsCenter documents={documents} currency={workspace.organization.currency} canUpload={WRITER_ROLES.includes(workspace.role)} signedUrls={Object.fromEntries(links)}/>;
}
